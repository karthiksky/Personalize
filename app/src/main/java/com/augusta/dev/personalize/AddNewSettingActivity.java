...
public class AddNewSettingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(edt_time.getText().toString().trim().length() == 0) {
                    Toast.makeText(AddNewSettingActivity.this, "Time cannot be empty.", Toast.LENGTH_SHORT).show();
                } else {
                    if(addData(edt_time.getText().toString(), spr_mode.getSelectedItem().toString())) {
                        Toast.makeText(AddNewSettingActivity.this, "Successfully added.", Toast.LENGTH_SHORT).show();
                        ...
                        Intent intent = new Intent(AddNewSettingActivity.this, AlarmBroadCastReceiver.class);
                        intent.setAction("alarm");
                        intent.putExtra("mode", spr_mode.getSelectedItem().toString());
                        alarmIntent = PendingIntent.getBroadcast(AddNewSettingActivity.this, Integer.parseInt(sReqCode), intent, 0);
                        ...
                        Toast.makeText(AddNewSettingActivity.this, "Some error is occur", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });

        String str_json_modes = Preference.getSharedPreferenceString(AddNewSettingActivity.this, Constants.MODES, "");
        ...
        arrayAdapter = new ArrayAdapter<String>(AddNewSettingActivity.this, android.R.layout.simple_spinner_dropdown_item, m_arr_modes);
        ...
        edt_time.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mTimePicker = new TimePickerDialog(AddNewSettingActivity.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
    ...
    private boolean addData(String time, String mode) {
        String strSettings = Preference.getSharedPreferenceString(AddNewSettingActivity.this, Constants.SETTINGS, "");
        ...
        if(strSettings.length() == 0) {
            try {
                ...
                Preference.setSharedPreferenceString(AddNewSettingActivity.this, Constants.SETTINGS, strSettings);
            } catch (JSONException e) {
                e.printStackTrace();
                return false;
            }
